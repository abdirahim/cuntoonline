		...
		{{ Form::open(['role' => 'form','url' =>'admin/text-setting/update-new-text/'.$result->id,'class' => 'mws-form']) }}
			<div class="mws-form-inline">
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						{{ Form::text('key', $result->key_value, ['class' => 'small','readonly']) }}
			...
			<div class="mws-button-row">
				<div class="input" >
					...
					<a href="{{URL::to('admin/text-setting/edit-new-text/'.$result->id )}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans("messages.common_text.reset") }}</a>
				</div>
			</div>
		{{ Form::close() }}
	</div>    	
