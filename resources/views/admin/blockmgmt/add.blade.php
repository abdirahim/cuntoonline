...
<div class="mws-panel grid_8">
	...
	@endif
	{{ Form::open(['role' => 'form','url' => 'admin/block-manager/add-block','class' => 'mws-form']) }}
	...
	<div class="mws-panel-body no-padding tab-content"> 
		...
		<div class="mws-button-row">
			<div class="input" >
				...
				<a href="{{URL::to('admin/block-manager/add-block')}}" class="btn primary"><i class=\"icon-refresh\"></i> Reset</a>
			</div>
		</div>
	</div>
	{{ Form::close() }} 
