...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span> {{ trans("messages.management.add_new_cms") }} </span>
	...
	<div class="mws-panel-body no-padding tab-content">
		...
		<div class="mws-button-row">
			<div class="input" >
				...
				<a href="{{URL::to('admin/cms-manager/add-cms')}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.management.reset') }}</a>
			</div>
		</div>
	</div>
	{{ Form::close() }} 
