 ...
 *
 * This file will render views from views/admin/languages/
 */
...
class LanguageSettingsController extends BaseController
{
    ...
    {
        $thisData  = Input::all();
        $validator = Validator::make($thisData, array(
            'default' => 'required'
        ));
        
        if ($validator->fails()) {
            return Redirect::to('admin/language-settings/add-setting')->withErrors($validator)->withInput();
        } else {
            ...
            return Redirect::to('admin/language-settings')->with('success', trans("messages.system_Management.language_add_msg"));
        }
    ...
    function updateLanguageSetting($Id)
    {
        ...
        if ($validator->fails()) {
            return Redirect::to('admin/language-settings/edit-setting/' . $Id)->withErrors($validator)->withInput();
        } else {
            ...
            return Redirect::to('admin/language-settings')->with('success', trans("messages.system_Management.language_edit_msg"));
        }
