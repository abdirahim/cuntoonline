 ...
 * <b>What does it do?</b>
 *
 * It manages file ss for you. In short, it manages the uploaded file,
...
class upload {
     ...
     *
     * Warning: for ss, this flag MUST be set to false for security reason
     *
     * @access public
     * @var bool
     */
...
/* 
    ...
    /**
     * Actually ss the file, and act on it according to the set processing class variables
     *
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            // if we haven't a temp file, and that we do check on ss, we use is_uploaded_file()
     ...
     *
     * When PHP ss a file, it stores it in a temporary location.
